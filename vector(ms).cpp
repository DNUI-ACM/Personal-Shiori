...
class Vector
{
  public:
    ...
    Vector(int cou, const T &value)
    {
        arr = (T *)malloc(sizeof(T) * cou);
    ...
    {
        arr = (T *)malloc(sizeof(T) * (V->_capacity));
    ...
    void reserve(unsigned long long new_cap)
    {
        ...
        else
        {
            ...
            //     T *arr1 = (T *)malloc(sizeof(T) * 2 * max_size);
            //     arr1 = arr;
  ...
  private:
    ...
    {
        T *arr1 = (T *)malloc(sizeof(T) * count);
    ...
    void d_cap()
    {
        T *arr1 = (T *)malloc(sizeof(T) * 2 * _capacity);
        for (int iter = 0; iter < _capacity; iter++)
        {
            arr1[iter] = arr[iter];
        }
